...
def calBreadCrumbUrl(num, pk):
	...
	"""
	if num == 0:
		return reverse('hw:college_all', args=())
	if num == ObjNum.COLLEGE:
		return reverse('hw:college_detail', args=(pk,))
	if num == ObjNum.SCHOOL:
		return reverse('hw:school_detail', args=(pk,))
	if num == ObjNum.MAJOR:
		return reverse('hw:major_detail', args=(pk,))
	if num == ObjNum.COURSE:
		return reverse('hw:course_detail', args=(pk,))
	return None
